...
class CreateObjectResponse(BaseModel):
    ...
    success: bool = Field(
        ..., examples=[True], description="Indicates if the object was successfully created in the graph."
    )
...
class DeleteObjectResponse(BaseModel):
    ...
    success: bool = Field(
        ..., examples=[True], description="Indicates if the object was successfully deleted from the graph."
    )
