...
class Settings(BaseSettings):
    ...
    # future real track iri = "https://foundry.ai.mil/ontology/4901-001/ObjectTrack"
    track_iri: str = Field("https://foundry.ai.mil/ontology/4901-001/TrackDisplay", description="IRI for Tracks")

    # Labels
    sm_generated_track: str = Field("SM_GENERATED_TRACK", description="Label for tracks generated by sensemaking")
