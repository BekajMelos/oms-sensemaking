...
class Settings(BaseSettings):
    ...
    sm_enriched: str = Field("SM_ENRICHED", description="Label for sensemaking enriched data")
    sm_inferenced: str = Field("SM_INFERENCED", description="Label for inferenced sensemaking data")
