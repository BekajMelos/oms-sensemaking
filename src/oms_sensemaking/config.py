...
class Settings(BaseSettings):
    ...
    maximum_oms_api_calls: int = Field(200,
    ...
    low_frequency_multiplier: int = Field(1, description="Low frequency multipler for maximum OMS API calls.")
    medium_frequency_multiplier: int = Field(3, description="Medium frequency multipler for maximum OMS API calls.")
    high_frequency_multiplier: int = Field(6, description="High frequency multipler for maximum OMS API calls.")
