...
class Settings(BaseSettings):
    ...
    geospatial_sm_label: str = Field("Geospatial SM", description="Label for geospatial sensemaking data")
    cotravel_sm_label: str = Field("Cotravel SM", description="Label for cotravel sensemaker")
    loiter_sm_label: str = Field("Loiter SM", description="Label for loiter sensemaker data")
    inference_sm_label: str = Field("Inference SM", description="Label for inference sensemaking data")
    incursion_sm_label: str = Field("Incursion Rule", description="Label for incursion sensemaking data")
    add_has_name_sm_label: str = Field("Has Name Rule", description="Label for has name sensemaking data")
    garrison_sm_label: str = Field("In/Out Garrison Rule", description="Label for garrison sensemaking data")
    mil_sym_sm_label: str = Field("Military Symbol SM", description="Label for mil sym sensemaking data")
    res_sm_label: str = Field("Resolution SM", description="Label for resolution sensemaking data")
