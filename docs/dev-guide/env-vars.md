...
| `ALTITUDE_THRESHOLD_METERS`                         | `20000`                                                                                           | Maximum altitude for an aircraft                               | No             |
| `ALTITUDE_DEVIATION_THRESHOLD_MPS`                  | `500`                                                                                             | Maximum climb/descent rate in meters per second                | No             |
| `TIME_THRESHOLD_SECONDS`                            | `5`                                                                                               | Minimum elapsed time between observations before filtering     | No             |
| `RELATIVE_VELOCITY_THRESHOLD_MPS`                   | `600`                                                                                             | Maximum horizontal velocity in meters per second               | No             |
| `TIME_BIN_TIME_SECONDS`                             | `60`                                                                                              | Size of bins to group points for time bin track weaver         | No             |
