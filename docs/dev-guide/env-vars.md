...
| `INFERENCE_TAGS`                                    | `'["Oms Sensemaking", "Inferred Data"]'`                                                          | Inference Tags                                                 | Yes            |
...
| `INFERENCE_INCURSION_CLASS_IRI`                     | `https://blackcape.io/PLACEHOLDER/Incursion`                                                      | Iri to apply for the Incursion Activity class                  | No             |
| `INFERENCE_INCURSION_AREAS_OF_INTEREST_PATH`        | `./data/areas_of_interest.json`                                                                   | Iri to apply for the Incursion Activity class                  | No             |
| `INFERENCE_PARTICIPATED_IN_IRI`                     | `https://blackcape.io/PLACEHOLDER/participatedIn`                                                 | Path to areas_of_interest.json file in oms-sensemaking         | No             |
