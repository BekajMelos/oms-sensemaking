...
| Variable Name              | Example                                            | Description                                                            | Docker Compose |
|:---------------------------|:---------------------------------------------------|:-----------------------------------------------------------------------|:--------------:|
| `OMSB_VERSION`             | `Grimlock-INC-37`                                  | The version of oms-bridge                                              | Yes            |
...
| `INFERENCE_INCURSION_AREAS_OF_INTEREST_PATH`        | `./data/areas_of_interest.json`                                                                   | Path to areas_of_interest.json file in atoms-sensemaking                            | No             |
