"""Added new Cotravel Potential Duplicate Finding Type.

Revision ID: 202601151616
Revises: 202512101040
Create Date: 2026-01-15 16:16:00.000000
...
new_options = sorted(old_options + ("COTRAVEL_POTENTIAL_DUPLICATE",))
...
def downgrade() -> None:
    ...
    op.execute(
        tcr.update().where(tcr.c.finding_type == "COTRAVEL_POTENTIAL_DUPLICATE").values(finding_type="GEO_COTRAVEL")
    )
